...
#
# THE IMPLEMENTATION IS PYTHON (scripts/ricelib/hypr/detectversion.py). This file locates
...
PYTHONPATH="$libdir${PYTHONPATH:+:$PYTHONPATH}" exec python3 -m ricelib.hypr.detectversion "$@"
